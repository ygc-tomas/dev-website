		...
		<div class="p-tab">
			<div class="p-tab__head">
				...
				<div class="p-postSort">
					...
					switch ($langClass) {
						case "ja":
							$cats = get_terms('pr_cat');
							break;
						case "en":
							$cats = get_terms('pr-en_cat');
							break;
						case "th":
							$cats = get_terms('pr-th_cat');
							break;
					}
					if ($cats): ?>
							...
							<div class="p-postSort__panel__inner">
								<ul class="p-postSort__category">
									<li class="p-postSort__category__item">
										<a href="<?php echo $langPath; ?>/pr" class="p-postSort__category__link">
											<?php switch ($langClass) {
												case 'ja': ?>
													すべて
												<?php break;
			...
			<div class="p-tab__body">
				<?php if (have_posts()): ?>
					<div class="p-postArchive03" data-col="4">
