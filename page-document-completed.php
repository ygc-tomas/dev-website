	...
	<div class="p-lowerMv__inner">
		...
		<nav class="p-lowerMv__bread">
			<ul class="p-lowerMv__bread__list">
				...
				<li class="p-lowerMv__bread__list__item">
					<a href="<?php echo $langPath; ?>/document">Document List</a>
				</li>
				<li class="p-lowerMv__bread__list__item">
			...
			<div class="p-section__contents">
				...
				<div class="c-heading">
					<h2 class="main">
						<?php switch ($langClass) {
							...
							<?php break;
							case 'en': ?>
								Request for materials completed
							<?php break;
							case 'th': ?>
								การขอเอกสารเรียบร้อยแล้ว
						<?php break;
						} ?>
					</h2>
				</div>
				<div class="c-sentence u-mt--16 u-mt--12--sp">
					<?php switch ($langClass) {
						case 'ja': ?>
							<p>
								お問合せを承りました。この度はTOMAS TECH CO.,LTD.にお問い合わせをいただきましてありがとうございます。内容を確認の上、担当者よりご連絡させていただきます。
							</p>
						<?php break;
						case 'en': ?>
							We have received your inquiry. Thank you for your inquiry to TOMAS TECH CO. Our representative will contact you after confirming the content of your inquiry.
						<?php break;
						case 'th': ?>
